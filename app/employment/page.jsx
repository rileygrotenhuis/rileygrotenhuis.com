        ...
        <Grid container>
                    ...
                    <Grid container>
                        <Grid item xs={12} lg={4} margin="auto">
                            <Image
                                alt="CompanyImage"
                                src={
                                    employmentData.data[currentEmployment].logo
                                }
                                width={300}
                                height={300}
                                style={{
                        ...
                        >
                            <Typography variant="pageTitle">
                                {employmentData.data[currentEmployment].company}
                            </Typography>
                            <Typography variant="pageSubtitle">
                                {
                                    employmentData.data[currentEmployment]
                                        .position
                                }{' '}
                                |
                                <em>
            ...
            >
                ...
                <Button
                    ...
                    disabled={Boolean(
                        currentEmployment === employmentData.data.length - 1
                    )}
                >
                    <ArrowForwardIcon
                        sx={{
